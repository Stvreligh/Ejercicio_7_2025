...
public class Ventana extends JFrame implements Ejecutable
{
    ...
    private void init(){
        ...
        jButton.addActionListener(p->{
            org.gerdoc.model.figura.Figura cuadrado = new Cuadrado( );
            ((Cuadrado)cuadrado).setLado( ReadUtil.string2Integer( jTextField.getText() ) );

            System.out.println( cuadrado.area( ) );
            System.out.println( cuadrado.perimetro( ) );

            JLabel perimetroCuadrado=new JLabel("Perimetro "+ cuadrado.perimetro());
            perimetroCuadrado.setBounds(10, 80, 100, 20);
            getContentPane().add(perimetroCuadrado);

            JLabel areaCuadrado=new JLabel("Area "+cuadrado.area());
        ...
        recboton.addActionListener(p->{
            org.gerdoc.model.figura.Figura rectangulo = new Rectangulo( );
            ((Rectangulo)rectangulo).setBase( ReadUtil.string2Integer( base.getText() ) );


            ((Rectangulo)rectangulo).setAltura(ReadUtil.string2Integer(altura.getText()));
            System.out.println( rectangulo.area( ) );
            System.out.println( rectangulo.perimetro( ) );

            JLabel perimetroRectangulo=new JLabel("Perimetro "+ rectangulo.perimetro());
            perimetroRectangulo.setBounds(10, 210, 100, 20);
            getContentPane().add(perimetroRectangulo);

            JLabel areaRectangulo=new JLabel("Area "+rectangulo.area());
        ...
        triboton.addActionListener(p->{
            org.gerdoc.model.figura.Figura triangulo = new Equilatero( );
            ((Equilatero)triangulo).setBase( ReadUtil.string2Integer( base2.getText() ) );
            ((Equilatero)triangulo).setLado1(ReadUtil.string2Integer(lado1.getText()));
            ((Equilatero)triangulo).setAltura(ReadUtil.string2Integer(altura2.getText()));
            System.out.println( triangulo.area( ) );
            System.out.println( triangulo.perimetro( ) );

            JLabel perimetroTriangulo=new JLabel("Perimetro "+ triangulo.perimetro());
            perimetroTriangulo.setBounds(10, 390, 100, 20);
            getContentPane().add(perimetroTriangulo);

            JLabel areaTriangulo=new JLabel("Area "+triangulo.area());
        ...
        tri2boton.addActionListener(p->{
            org.gerdoc.model.figura.Figura triangulo2 = new Isosceles( );
            ((Isosceles)triangulo2).setBase( ReadUtil.string2Integer( base3.getText() ) );
            ((Isosceles)triangulo2).setLado1(ReadUtil.string2Integer(lado12.getText()));
            ((Isosceles)triangulo2).setAltura(ReadUtil.string2Integer(altura3.getText()));
            ((Isosceles)triangulo2).setLado2(ReadUtil.string2Integer(lado2.getText()));
            System.out.println( triangulo2.area( ) );
            System.out.println( triangulo2.perimetro( ) );

            JLabel perimetroTriangulo2=new JLabel("Perimetro "+ triangulo2.perimetro());
            perimetroTriangulo2.setBounds(10, 610, 100, 20);
            getContentPane().add(perimetroTriangulo2);

            JLabel areaTriangulo2=new JLabel("Area "+triangulo2.area());
        ...
        tri3boton.addActionListener(p->{
            org.gerdoc.model.figura.Figura triangulo3 = new Escaleno( );
            ((Escaleno)triangulo3).setBase( ReadUtil.string2Integer( base4.getText() ) );
            ((Escaleno)triangulo3).setLado1(ReadUtil.string2Integer(lado13.getText()));
            ((Escaleno)triangulo3).setAltura(ReadUtil.string2Integer(altura4.getText()));
            ((Escaleno)triangulo3).setLado2(ReadUtil.string2Integer(lado21.getText()));
            ((Escaleno)triangulo3).setLado3(ReadUtil.string2Integer(lado3.getText()));
            System.out.println( triangulo3.area( ) );
            System.out.println( triangulo3.perimetro( ) );

            JLabel perimetroTriangulo2=new JLabel("Perimetro "+ triangulo3.perimetro());
            perimetroTriangulo2.setBounds(400, 240, 100, 20);
            getContentPane().add(perimetroTriangulo2);

            JLabel areaTriangulo2=new JLabel("Area "+triangulo3.area());
        ...
        penboton.addActionListener(p->{
            org.gerdoc.model.figura.Figura pentagono = new Pentagono( );
            ((Pentagono)pentagono).setLado( ReadUtil.string2Integer( ladop.getText() ) );


            ((Pentagono)pentagono).setApotema(ReadUtil.string2Integer(apotema.getText()));
            System.out.println( pentagono.area( ) );
            System.out.println( pentagono.perimetro( ) );

            JLabel perimetroPentagono=new JLabel("Perimetro "+ pentagono.perimetro());
            perimetroPentagono.setBounds(400, 380, 100, 20);
            getContentPane().add(perimetroPentagono);

            JLabel areaPentagono=new JLabel("Area "+pentagono.area());
        ...
        hexboton.addActionListener(p->{
            org.gerdoc.model.figura.Figura hexagono = new Hexagono( );
            ((Hexagono)hexagono).setLado( ReadUtil.string2Integer( ladoh.getText() ) );


            ((Hexagono)hexagono).setApotema(ReadUtil.string2Integer(apotema2.getText()));
            System.out.println( hexagono.area( ) );
            System.out.println( hexagono.perimetro( ) );

            JLabel perimetroHexagono=new JLabel("Perimetro "+ hexagono.perimetro());
            perimetroHexagono.setBounds(400, 520, 100, 20);
            getContentPane().add(perimetroHexagono);

            JLabel areaHexagono=new JLabel("Area "+hexagono.area());
        ...
        octboton.addActionListener(p->{
            org.gerdoc.model.figura.Figura octagono = new Octagono( );
            ((Octagono)octagono).setLado( ReadUtil.string2Integer( ladoo.getText() ) );


            ((Octagono)octagono).setApotema(ReadUtil.string2Integer(apotema3.getText()));
            System.out.println( octagono.area( ) );
            System.out.println( octagono.perimetro( ) );

            JLabel perimetroOctagono=new JLabel("Perimetro "+ octagono.perimetro());
            perimetroOctagono.setBounds(400, 660, 100, 20);
            getContentPane().add(perimetroOctagono);

            JLabel areaOctagono=new JLabel("Area "+octagono.area());
        ...
        circboton.addActionListener(p->{
            ...
            ((Circulo)circulo).setRadio( ReadUtil.string2Integer( radio.getText() ) );

            System.out.println( circulo.area( ) );
            System.out.println( circulo.perimetro( ) );

            JLabel perimetroCirculo=new JLabel("Perimetro "+ circulo.perimetro());
            perimetroCirculo.setBounds(790, 80, 100, 20);
            getContentPane().add(perimetroCirculo);

            JLabel areaCirculo=new JLabel("Area "+circulo.area());
